SELECT DimCustomer.CustomerKey,CONCAT(FirstName ,' ',MiddleName,' ',LastName) as FullName , Count(FactInternetSales.ProductKey) as SalesOrderNumber
FROM DimCustomer
